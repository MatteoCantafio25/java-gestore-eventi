...
public class Main {
    public static void main(String[] args) {
        ...
        if (!Objects.equals(eventTitle, "") || eventDate != null){
            Event event = new Event(eventTitle, eventDate, totalEventSeats);
            ...
            System.out.println("Error during the inizialization of the event");
        }
